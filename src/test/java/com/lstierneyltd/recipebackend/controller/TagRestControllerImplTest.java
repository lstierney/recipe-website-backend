...
import static com.lstierneyltd.recipebackend.controller.TagRestControllerImpl.COULD_NOT_FIND_TAG_WITH_ID;
...
public class TagRestControllerImplTest {
    ...
    public void testUpdateTag_tagFound() {
        ...
        // When
        tagRestController.updateTag(ID, newTag);
    ...
    public void testUpdateTag_tagNotFound() {
        ...
        // When
        Exception exception = assertThrows(EntityNotFoundException.class, () -> {
            tagRestController.updateTag(ID, getNewTag());
        });
